...
int main(int argc, char* argv[])
{
	...
	auto pClient = mgr.AddTCPClient("tcpclient", LOG_LEVEL, 300, "127.0.0.1", 20000);
	...
	do {
		...
		if(cmd == "exit") break;
			...
			cout<<"CROB string-- "<<crob.ToString();
			promise<CommandResponse> selectResult;
			pCmdProcessor->DirectOperate(crob, 0, [&](CommandResponse cr) {
